...
const CollegeGroupsPage: React.FC = () => {
  ...
  const loadGroups = async () => {
    try {
      setLoading(true);
      // In a real implementation, you would filter groups by college
  ...
  const collegeName = collegeId ? collegeNames[collegeId] || 'College Groups' : 'College Groups';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="mt-2 text-gray-700">
                Connect with fellow students from {collegeName} traveling on similar routes
              </p>
            ...
            <button
              onClick={() => navigate('/groups?view=create')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="ridepool-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-2xl font-bold text-gray-900">
                  {Math.round(groups.reduce((acc, group) => acc + (group.members.length / group.seatCount * 100), 0) / groups.length || 0)}%
                </h3>
                <p className="text-gray-600">Avg. Group Utilization</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="ridepool-card p-6 animate-fadeIn">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">Groups from {collegeName}</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Be the first to create a group for {collegeName}!
              </p>
              <div className="mt-6">
                <button
                  onClick={() => navigate('/groups?view=create')}
...
export default CollegeGroupsPage;