    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-gray-300">Save money, reduce emissions, and connect with fellow students</p>
        </div>
        ...
        <div className="ridepool-card mb-10">
          <div className="flex items-start p-6">
            ...
            <div className="ml-4">
              ...
              <div className="mt-5 p-4 bg-gray-800 bg-opacity-50 rounded-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="ridepool-card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <button 
                  ...
                  className="ridepool-btn ridepool-btn-primary py-5 px-6 rounded-xl flex flex-col items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="h-8 w-8 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  <span className="font-medium">Create Group</span>
                  <span className="text-sm text-green-200 mt-2">Start a new ride pool</span>
                </button>
                
                <button 
                  onClick={handleJoinGroup}
                  className="ridepool-btn ridepool-btn-secondary py-5 px-6 rounded-xl flex flex-col items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="h-8 w-8 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                  </svg>
                  <span className="font-medium">Join Group</span>
                  <span className="text-sm text-blue-200 mt-2">Find existing pools</span>
                </button>
                
                <button 
                  onClick={() => navigate('/groups')}
                  className="ridepool-btn ridepool-btn-tertiary py-5 px-6 rounded-xl flex flex-col items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="h-8 w-8 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <span className="font-medium">All Groups</span>
                  <span className="text-sm text-green-200 mt-2">Browse all groups</span>
                </button>
              </div>
            </div>
              ...
              {recentGroups.length > 0 ? (
                <div className="space-y-5">
                  {recentGroups.map((group) => (
                    <div 
                      key={group._id} 
                      className="flex items-center p-5 bg-gray-800 bg-opacity-50 rounded-lg hover:bg-gray-700 hover:bg-opacity-50 transition-colors cursor-pointer"
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Get started by creating your first group.</p>
                  <div className="mt-8">
                    <button
                      onClick={handleCreateGroup}
                      className="ridepool-btn ridepool-btn-primary px-5 py-3 rounded-lg"
                    >
                      Create Group
                    </button>
                  </div>
          ...
          <div className="space-y-10">
            {/* Upcoming Rides */}
            <div className="ridepool-card">
              <h2 className="text-xl font-bold text-white mb-8">Upcoming Rides</h2>
              <div className="space-y-5">
                <div className="p-5 bg-gray-800 bg-opacity-50 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm mt-2">8:00 AM • Main Gate → Academic Block</p>
                  <div className="flex items-center mt-4">
                    <div className="flex -space-x-2">
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-green-500 to-emerald-500"></div>
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-green-400 to-teal-500"></div>
                    </div>
                    <span className="text-xs text-gray-400 ml-3">2 members</span>
                  </div>
                </div>
                ...
                <div className="p-5 bg-gray-800 bg-opacity-50 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm mt-2">5:30 PM • Academic Block → Main Gate</p>
                  <div className="flex items-center mt-4">
                    <div className="flex -space-x-2">
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-green-500 to-emerald-500"></div>
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-green-400 to-teal-500"></div>
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-yellow-500 to-amber-500"></div>
                    </div>
                    <span className="text-xs text-gray-400 ml-3">3 members</span>
                  </div>
                </div>
              </div>
            </div>
